...
public class Simulation implements Serializable {
    ...
    public Simulation modified(LocalDate modified) {
    ...
    public Simulation userCreation(String userCreation) {
    ...
    public Simulation userCurrent(String userCurrent) {
    ...
    public Simulation course(Course course) {
