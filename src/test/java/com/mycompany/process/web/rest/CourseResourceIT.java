...
import com.mycompany.process.domain.Course;
import com.mycompany.process.repository.CourseRepository;
...
class CourseResourceIT {
    ...
    public static Course createEntity(EntityManager em) {
        Course course = new Course().name(DEFAULT_NAME).label(DEFAULT_LABEL).offerId(DEFAULT_OFFER_ID);
        return course;
    }
    ...
    public static Course createUpdatedEntity(EntityManager em) {
        Course course = new Course().name(UPDATED_NAME).label(UPDATED_LABEL).offerId(UPDATED_OFFER_ID);
        return course;
    }
    ...
    void createCourse() throws Exception {
        ...
        assertThat(testCourse.getLabel()).isEqualTo(DEFAULT_LABEL);
        assertThat(testCourse.getOfferId()).isEqualTo(DEFAULT_OFFER_ID);
    }
    ...
    void putNewCourse() throws Exception {
        ...
        updatedCourse.name(UPDATED_NAME).label(UPDATED_LABEL).offerId(UPDATED_OFFER_ID);
        ...
        assertThat(testCourse.getLabel()).isEqualTo(UPDATED_LABEL);
        assertThat(testCourse.getOfferId()).isEqualTo(UPDATED_OFFER_ID);
    }
    ...
    void partialUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.offerId(UPDATED_OFFER_ID);
    ...
    void fullUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.name(UPDATED_NAME).label(UPDATED_LABEL).offerId(UPDATED_OFFER_ID);
